...
<div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
    <div class="container d-flex">
        <div class="contact-info mr-auto">
            <i class="icofont-envelope"></i> <a href="mailto:contact@example.com">Mecadoverde@gmail.com</a>
            <i class="icofont-phone"></i> +55 (83) 5589 5548
        </div>
...
<header id="header" class="fixed-top">
    ...
    {{--      <h1 class="logo mr-auto"><a href="welcome.bladeOLD.php">MERCADO VERDE</a></h1>--}}
...
{{--                <li><a href="#contact">Contact</a></li>--}}
        ...
        <a href="#about" class="get-started-btn scrollto">Cestas Prontas</a>


        @auth
            <a href="{{ url('/Logado') }}" class="get-started-btn scrollto">Dashboard</a>
        @else
            <a href="{{ route('login') }}" class="get-started-btn scrollto">Login</a>

            @if (Route::has('register'))
                <a href="{{ route('register') }}" class="get-started-btn scrollto">Cadastre-se</a>
            @endif
        @endif
